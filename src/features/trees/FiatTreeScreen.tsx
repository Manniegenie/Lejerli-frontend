...
export default function FiatTreeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.leftPane}>
        ...
        <View style={[styles.ctaRow, { paddingLeft: 45 }]}>
          <TouchableOpacity style={styles.ctaChannels} activeOpacity={0.85} onPress={() => router.push('/(app)/trees/crypto')}>
          ...
          <View style={styles.contentInner}>
            ...
            <View style={styles.channelList}>
              {channels.length === 0 ? (
                <EmptyState
                  size="sm"
                  message="No fiat channels connected"
