...
export default function CryptoTreeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.leftPane}>
        ...
        <View style={styles.ctaRow}>
          <TouchableOpacity style={styles.ctaChannels} activeOpacity={0.85} onPress={() => router.push('/(app)/dashboard')}>
        ...
        <View style={styles.ctaRow}>
          <TouchableOpacity style={styles.ctaChannels} activeOpacity={0.85} onPress={() => router.push('/(app)/channels')}>
        ...
        <View style={styles.ctaRow}>
          <TouchableOpacity style={styles.ctaChannels} activeOpacity={0.85} onPress={() => router.push('/(app)/trees/expansion')}>
        ...
        <View style={[styles.ctaRow, { paddingLeft: 45 }]}>
          <TouchableOpacity style={styles.ctaChannels} activeOpacity={0.85} onPress={() => router.push('/(app)/trees/fiat')}>
          ...
          <View style={styles.contentInner}>
            ...
            <View style={styles.channelList}>
              {channels.length === 0 ? (
                <EmptyState
                  size="sm"
                  message="No crypto channels connected"
                  sub="Add a channel from the Channels page to get started."
                />
              ) : (
...
const styles = StyleSheet.create({
  ...
  userEmail: { color: '#999999', fontSize: 12, fontFamily: 'GeneralSans' },
  signOutButton: { height: 44, borderWidth: 1, borderColor: '#2a2a2a', borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  signOutText: { fontSize: 14, fontWeight: '500', color: '#bbbbbb', fontFamily: 'GeneralSans' },
  ...
  pageSubtitle: { fontSize: 15, color: '#bbbbbb', fontFamily: 'GeneralSans' },
